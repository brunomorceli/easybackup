 ...
 */
module.exports.getTimestamp = (dateObj) => {
 ...
 */
module.exports.getDateNumber = (filename) => {
 ...
 */
module.exports.getDateText = (filename) => {
 ...
 */
module.exports.getMostRecent = (filename1, filename2) => {
